...
<html>
	...
	<?php  include './view/header.php';?>		
			<div id="nav-mid">
				...
				<div class="actu">
					<h2> Inauguration de notre site </h2>

					<img class="image_actu" src="./Pictures/inauguration.png" alt="Inauguration !!"/>
					<p> <mark> Mercredi 9 Novembre </mark> <br/> Notre nouveau site sera inauguré! </p>
